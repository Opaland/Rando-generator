 ...
 *
 * `loadAutour` part chercher une zone chez Overpass, que `fetch` n'existe pas
 * pour servir : le chargement échoue, `zoneError` se remplit, et **ce n'est
 * pas ce qu'on mesure ici**. Ce qui est mesuré est ce qu'il advient des
 * quatre champs de la recherche, et l'échec de la zone n'y touche pas.
 */
